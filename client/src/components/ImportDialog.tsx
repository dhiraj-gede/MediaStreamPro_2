...
export const ImportDialog: React.FC<ImportDialogProps> = ({ isOpen, onClose }) => {
  ...
  const importMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({
        title: 'Import failed',
        description: error.message || 'There was an error importing the file from Google Drive.',
        variant: 'destructive'
      });
    }
  });
        ...
        <div className="py-4 space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              The file ID is the part of the URL after "https://drive.google.com/file/d/" and before "/view"
            </p>
          </div>
